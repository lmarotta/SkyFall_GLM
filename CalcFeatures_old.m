...
for j=1:3
    if j<=2
        ...
        FC= [FC, DCM,  DCMed, DCstd, DCS, DCK, DCCorrV, DCFFT_re, DCFFT_im,  DCFFT_abs, DCfit, DDCM, DDCMed, DDCstd, DDCS, DDCK, DDCCorrV, DDCFFT_re, DDCFFT_im,  DDCFFT_abs, DDCfit, NEWFEAT, FFTENT, DFFTENT, DCENT, XP, DCENERGY, FFTENERGY];
