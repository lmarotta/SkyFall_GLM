...
%                         DCFFT_abs= [DCFFT_abs trapz(abs(DCFFT(floor(length(DCFFT)/40*(ii-1)+1):floor(length(DCFFT)/40*ii),jj)'))/trapz(abs(DCFFT(:,jj)'))];
%                     end
%                 end
%             end
%             
...
%                         DDCFFT_abs= [DDCFFT_abs trapz(abs(DDCFFT(floor(length(DCFFT)/40*(ii-1)+1):floor(length(DDCFFT)/40*ii),jj)'))/trapz(abs(DDCFFT(:,jj)'))];
%                     end
%                 end
%             end
%             
...
%                         DCFFT_abs= [DCFFT_abs trapz(abs(DCFFT(floor(length(DCFFT)/5*(ii-1)+1):floor(length(DCFFT)/5*ii),jj)'))/trapz(abs(DCFFT(:,jj)'))];
%                     end
%                 end
%             end
%             
...
%         
%     end;
    FC=CalcFeatures(data,stamp,new_FFT,eps);
